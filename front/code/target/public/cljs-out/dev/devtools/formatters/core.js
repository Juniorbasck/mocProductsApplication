...
var and__5041__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__5041__auto__){
var or__5043__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e13810){var _e__9359__auto__ = e13810;
return false;
...
}catch (e13812){var _e__9359__auto__ = e13812;
return false;
...
}catch (e13814){var _e__9359__auto__ = e13814;
return false;
...
}catch (e13816){var _e__9359__auto__ = e13816;
return false;
...
}catch (e13818){var _e__9359__auto__ = e13818;
return false;
}})())){
...
}catch (e13820){var _e__9359__auto__ = e13820;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__13822 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13823 = (function (){var or__5043__auto__ = config;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13823);

try{return raw_fn.call(null,value);
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13822);
}});
});
...
while (G__13826__i < G__13826__a.length) {G__13826__a[G__13826__i] = arguments[G__13826__i + 0]; ++G__13826__i;}
  args = new cljs.core.IndexedSeq(G__13826__a,0,null);
} 
...
var args = cljs.core.seq(arglist__13827);
...
var pre_handler = (function (){var or__5043__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var post_handler = (function (){var or__5043__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return cljs.core.identity;
