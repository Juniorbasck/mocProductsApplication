...
var G__10293 = devtools.prefs.pref.call(null,v);
v = G__10293;
continue;
} else {
return v;
...
}catch (e10294){var _e__9359__auto__ = e10294;
return false;
}})();
...
}catch (e10296){var _e__9359__auto__ = e10296;
return false;
}})();
...
}catch (e10298){var _e__9359__auto__ = e10298;
return false;
}}
}
});
...
var vec__10300 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10300,(0),null);
var name = cljs.core.nth.call(null,vec__10300,(1),null);
...
return cljs.core.some.call(null,(function (p1__10303_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10303_SHARP_);
}),template);
});
