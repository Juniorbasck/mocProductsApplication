...
var len__5766__auto___10356 = arguments.length;
var i__5767__auto___10357 = (0);
while(true){
if((i__5767__auto___10357 < len__5766__auto___10356)){
args__5772__auto__.push((arguments[i__5767__auto___10357]));

var G__10358 = (i__5767__auto___10357 + (1));
i__5767__auto___10357 = G__10358;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10353){
var G__10354 = cljs.core.first.call(null,seq10353);
var seq10353__$1 = cljs.core.next.call(null,seq10353);
var G__10355 = cljs.core.first.call(null,seq10353__$1);
var seq10353__$2 = cljs.core.next.call(null,seq10353__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10354,G__10355,seq10353__$2);
}));
...
if(cljs.core.truth_((function (){var or__5043__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
if(or__5043__auto__){
...
return cljs.core._write.call(null,writer__5328__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__5041__auto__){
var or__5043__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10359_SHARP_){
return (!((cljs.core.meta.call(null,p1__10359_SHARP_) == null)));
})))){
...
if(cljs.core.truth_((function (){var and__5041__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"render-path-annotations","render-path-annotations",-1890931512));
...
var markup_db = cljs.core.get.call(null,map__10360__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10361){var _e__9359__auto__ = e10361;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e10363){var _e__9359__auto__ = e10363;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__10365 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__10366 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__10366);
...
var map__10367 = opts;
var map__10367__$1 = cljs.core.__destructure_map.call(null,map__10367);
var markup_db = cljs.core.get.call(null,map__10367__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__10365);
}});
...
var temp__5802__auto___10371 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5802__auto___10371)){
var managed_print_level_10372 = temp__5802__auto___10371;
var _STAR_print_level_STAR__orig_val__10369_10373 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10370_10374 = managed_print_level_10372;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10370_10374);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__10368_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10368_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10369_10373);
}} else {
job_fn.call(null);
}
